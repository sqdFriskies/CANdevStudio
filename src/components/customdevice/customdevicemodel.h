...
/**
 *   @brief The class provides node graphical representation of CustomDevice
 */
class CustomDeviceModel : public ComponentModel<CustomDevice, CustomDeviceModel> {
    Q_OBJECT
...
public:
     ...
     *   @param  type of port
     *   @patam  port id
     *   @return CustomDeviceDataOut type if portType is out, CustomDeviceDataIn type if portType is in
     */
     ...
     *   @param  port id
     *   @return CustomDeviceDataOut or CustomDeviceDataIn filled with data
     */
...
public slots:
    ...
    /**
     *   @brief  Callback, called when CustomDevice emits signal frameReceived
