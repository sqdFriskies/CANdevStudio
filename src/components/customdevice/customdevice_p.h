...
class CustomDevicePrivate : public QObject {
    Q_OBJECT
    Q_DECLARE_PUBLIC(CustomDevice)

public:
    CustomDevicePrivate(CustomDevice* q, CustomDeviceCtx&& ctx = CustomDeviceCtx(new CustomDeviceQt()))
        : _ctx(std::move(ctx))
        , _canDevice(_ctx.get<CustomDeviceInterface>())
        , q_ptr(q)
    {
        initProps();
...
public:
    CustomDeviceCtx _ctx;
    QVector<QCanBusFrame> _sendQueue;
    CustomDeviceInterface& _canDevice;
    ...
    ComponentInterface::ComponentProperties _supportedProps = {
            ...
            std::make_tuple(_backendProperty,  QVariant::String, true, cf([this] {
                    ...
                    connect(p, &PropertyFieldCombo::currentTextChanged, this, &CustomDevicePrivate::backendChanged);
            ...
            std::make_tuple(_interfaceProperty, QVariant::String, true, cf([&] {
                    ...
                    _prevConn = connect(this, &CustomDevicePrivate::backendChanged, [p](const QString& backend){
                            QString errorString;
