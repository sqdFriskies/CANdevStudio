...
TEST_CASE("Invalid parameters init fails", "[customdeviceqt]")
{
    CustomDeviceQt dev;
    REQUIRE(dev.init("", "") == false);
}

TEST_CASE("Uninitialized device", "[customdeviceqt]")
{
    CustomDeviceQt dev;
    QCanBusFrame frame;
...
TEST_CASE("Correct init parameters", "[customdeviceqt]")
{
    CustomDeviceQt dev;
    REQUIRE(dev.init("virtualcan", "can0") == true);
}

TEST_CASE("Initialized device", "[customdeviceqt]")
{
    CustomDeviceQt dev;
    QCanBusFrame frame;
...
TEST_CASE("Thread", "[customdeviceqt]")
{
    CustomDeviceQt dev;
    QEventLoop el;
